...
TEST_CASES = [
  ...
  (400, VehicleUpdateRequestFactory.build(True, vendor="foo"), None),
  (400, None, None),
]
...
@pytest.mark.parametrize(
  "status_code, update_request, entity",
  TEST_CASES,
  ids=IDs
)
def test_update(
  ...
  with (
    ...
    patch("vehicle_api.api_resolver.Dynamo.findByID") as mock,
  ):
    mock.return_value = entity
    # When
    event = {
      "httpMethod": "PUT", "path": "/vehicle/v1/id",
      "body": (
